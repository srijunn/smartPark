...
async function seed() {
    ...
    const slotConfigs = [
        // Floor 1 — Block A
        { block: "A", number: 101, floor: 1, nodeId: "s-A-101", type: "REGULAR", xCoord: 80, yCoord: 40, features: ["near_entry"] },
        { block: "A", number: 102, floor: 1, nodeId: "s-A-102", type: "REGULAR", xCoord: 230, yCoord: 40, features: [] },
        { block: "A", number: 103, floor: 1, nodeId: "s-A-103", type: "EV_CHARGING", xCoord: 380, yCoord: 40, features: ["ev_charging"] },
        { block: "A", number: 104, floor: 1, nodeId: "s-A-104", type: "REGULAR", xCoord: 80, yCoord: 70, features: ["near_entry"] },
        { block: "A", number: 105, floor: 1, nodeId: "s-A-105", type: "HANDICAPPED", xCoord: 230, yCoord: 70, features: ["handicapped"] },
        { block: "A", number: 106, floor: 1, nodeId: "s-A-106", type: "PREMIUM", xCoord: 380, yCoord: 70, features: ["shaded", "premium"] },
        // Floor 1 — Block B
        { block: "B", number: 101, floor: 1, nodeId: "s-B-101", type: "REGULAR", xCoord: 80, yCoord: 190, features: [] },
        { block: "B", number: 102, floor: 1, nodeId: "s-B-102", type: "REGULAR", xCoord: 230, yCoord: 190, features: ["shaded"] },
        { block: "B", number: 103, floor: 1, nodeId: "s-B-103", type: "REGULAR", xCoord: 380, yCoord: 190, features: [] },
        { block: "B", number: 104, floor: 1, nodeId: "s-B-104", type: "REGULAR", xCoord: 80, yCoord: 220, features: [] },
        { block: "B", number: 105, floor: 1, nodeId: "s-B-105", type: "EV_CHARGING", xCoord: 230, yCoord: 220, features: ["ev_charging"] },
        { block: "B", number: 106, floor: 1, nodeId: "s-B-106", type: "REGULAR", xCoord: 380, yCoord: 220, features: [] },
        // Floor 1 — Block C
        { block: "C", number: 101, floor: 1, nodeId: "s-C-101", type: "REGULAR", xCoord: 80, yCoord: 340, features: [] },
        { block: "C", number: 102, floor: 1, nodeId: "s-C-102", type: "REGULAR", xCoord: 230, yCoord: 340, features: ["near_exit"] },
        { block: "C", number: 103, floor: 1, nodeId: "s-C-103", type: "PREMIUM", xCoord: 380, yCoord: 340, features: ["premium", "shaded"] },
        { block: "C", number: 104, floor: 1, nodeId: "s-C-104", type: "REGULAR", xCoord: 80, yCoord: 370, features: [] },
        { block: "C", number: 105, floor: 1, nodeId: "s-C-105", type: "HANDICAPPED", xCoord: 230, yCoord: 370, features: ["handicapped"] },
        { block: "C", number: 106, floor: 1, nodeId: "s-C-106", type: "REGULAR", xCoord: 380, yCoord: 370, features: [] },
        // Floor 2 — Block A
        { block: "A", number: 201, floor: 2, nodeId: "s-A-201", type: "REGULAR", xCoord: 80, yCoord: 540, features: [] },
        { block: "A", number: 202, floor: 2, nodeId: "s-A-202", type: "REGULAR", xCoord: 230, yCoord: 540, features: [] },
        { block: "A", number: 203, floor: 2, nodeId: "s-A-203", type: "EV_CHARGING", xCoord: 380, yCoord: 540, features: ["ev_charging"] },
        { block: "A", number: 204, floor: 2, nodeId: "s-A-204", type: "REGULAR", xCoord: 80, yCoord: 570, features: [] },
        { block: "A", number: 205, floor: 2, nodeId: "s-A-205", type: "REGULAR", xCoord: 230, yCoord: 570, features: [] },
        { block: "A", number: 206, floor: 2, nodeId: "s-A-206", type: "PREMIUM", xCoord: 380, yCoord: 570, features: ["premium", "shaded"] },
    ];
    // Create all slots
    const createdSlots = {}; // nodeId -> slotId mapping
    ...
    for (let day = 13; day >= 0; day--) {
        for (let hour = 6; hour <= 22; hour++) {
            ...
            let baseOccupancy = 5;
            if (hour >= 8 && hour <= 10)
                baseOccupancy = 16; // Morning rush
            else if (hour >= 11 && hour <= 14)
                baseOccupancy = 20; // Lunch peak
            else if (hour >= 17 && hour <= 19)
                baseOccupancy = 18; // Evening rush
            else if (hour >= 15 && hour <= 16)
                baseOccupancy = 14; // Afternoon
            else
                baseOccupancy = 6 + Math.floor(Math.random() * 5); // Off-peak
            // Add noise + weekend variation
            const isWeekend = (timestamp.getDay() === 0 || timestamp.getDay() === 6);
            if (isWeekend)
                baseOccupancy = Math.floor(baseOccupancy * 0.6); // 60% on weekends
            const occupancy = Math.min(totalSlots, Math.max(0, baseOccupancy + Math.floor(Math.random() * 5) - 2));
