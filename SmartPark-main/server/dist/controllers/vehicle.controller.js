...
export const getMyVehicles = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, vehicles.map((v) => ({
        id: v.id,
        rfidTag: v.rfidTag,
        plateNo: v.plateNo,
...
export const updateVehicle = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, updated, "Vehicle updated"));
});
// ── Delete Vehicle ───────────────────────────────────────────
export const deleteVehicle = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, null, "Vehicle deleted"));
});
