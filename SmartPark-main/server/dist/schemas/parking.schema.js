...
export const manualEntrySchema = z.object({
    ...
    lotId: z.string().min(1),
}).refine((data) => data.vehicleId || data.rfidTag || data.plateNo, { message: "At least one of vehicleId, rfidTag, or plateNo is required" });
export const manualExitSchema = z.object({
    sessionId: z.string().uuid().optional(),
    rfidTag: z.string().optional(),
    plateNo: z.string().optional(),
}).refine((data) => data.sessionId || data.rfidTag || data.plateNo, { message: "At least one of sessionId, rfidTag, or plateNo is required" });
