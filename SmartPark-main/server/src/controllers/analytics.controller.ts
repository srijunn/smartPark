...
export const getPeakHours = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(
    new ApiResponse(200, result, "Peak hours analysis complete")
  );
});
...
export const getRevenueStats = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(
    new ApiResponse(200, result, "Revenue statistics fetched")
  );
});
...
export const getPredictions = asyncHandler(async (req, res) => {
  ...
  const targetHour = parseInt(req.query.hour as string);
  ...
  return res.status(200).json(
    new ApiResponse(200, result, "Prediction generated")
  );
});
...
export const getAllHoursPrediction = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(
    new ApiResponse(200, predictions, "24-hour prediction generated")
  );
});
...
export const getRecentLogs = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(
    new ApiResponse(200, sessions.map((s) => ({
      id: s.id,
